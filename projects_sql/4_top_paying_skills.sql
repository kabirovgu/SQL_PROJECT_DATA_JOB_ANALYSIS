...
Answer: What ar the top paying skills based on salary?
---Look at the average salary associated with each skill for data Analyst positions
---Focuses on roles with specified salaries, regardleass of location
---Why? It reveals how different skills impact salary levels for Data Analyst and 
    help identify the most financially skills to acquire or improve
...
/*
Here is the beakdown of results :
